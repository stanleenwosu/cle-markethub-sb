...
const PaymentSuccessPage = () => {
  ...
  console.log('🚀 ~ PaymentSuccessPage ~ order', order);
  const breadCrumb = [
    {
      text: 'Home',
      url: '/',
                  ...
                  <div className="col-xl-8 col-lg-8 col-md-12 col-sm-12">
                    <div className="ps-block--payment-success">
                      <div className="ps-block__content">
                        ...
                        <p>
                          Your order serial is <strong>{order.order.id}</strong>
                        </p>
                        <p>
                          An email will be sent containing information about
                          your purchase. If you have any questions about your
                          purchase, email us at{' '}
                          <a
                            href="mailto@contact@martfury.com"
                            className="ps-highlight">
                            <strong>contact@clemarkethub.com</strong>
                          </a>
                        </p>
                      </div>
