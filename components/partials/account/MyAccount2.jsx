          ...
          <div className="ps-section__wrapper">
            ...
            <div className="ps-section__right">
              <figure className="ps-section__desc">
                ...
                <p>
                  CLE Marketplace Buyer Protection has you covered from click to
              ...
              <div className="ps-section__coupon">
                ...
                <aside>
                  ...
                  <p>
                    CLE Marketplace give ₦250 as a small gift for your first
                    purchase. Welcome to CLE Marketplace!
                  </p>
                </aside>
              </div>
            </div>
