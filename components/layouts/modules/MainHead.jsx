...
const MainHead = () => (
  <Head>
    ...
    <link rel="icon" href="/static/img/favicon.png" sizes="192x192" />
    ...
    <meta name="keywords" content="CLE, ecommerce, marketplace" />
    <meta name="description" content="CLE Marketplace" />
    <link
